# Code adapted from tilelang src at: https://github.com/tile-ai/tilelang/blob/main/examples/flash_decoding/example_gqa_decode_varlen_logits.py
...
# best config {'block_N': 128, 'block_H': 64, 'num_split': 1, 'num_stages': 1, 'threads': 128}
def flash_decode_gqa_varlen(
    q: torch.Tensor,
    k: torch.Tensor,
    v: torch.Tensor,
    ...
    output, _ = kernel(q, k, v, cu_seqlens_k, s_aux,)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--k_seqlen", type=int, default=4096, help="Key sequence length")
