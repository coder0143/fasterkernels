import torch
from fskernels.cuda.cuda_fa2 import flash_attention_2_fwd

device = "cuda"
dtype = torch.float16 # Using native FP16 values for our custom half boundaries
...
tri_out = flash_attention_2_fwd(q, k, v, sm_scale)
...
print("✅ CUDA FA2 Kernel Precision Match Confirmed!")
